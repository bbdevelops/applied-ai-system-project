...
![High-Energy Pop default run](img/terminal_output_high_energy_pop_v2.png)
...
![Conflicting Moods fallback run](img/terminal_output_conflicting_moods_fallback_v2.png)
...
> *TODO — to be completed manually. The Week 9 rubric asks for a short reflection covering:*
>
...
A longer narrative reflection lives in [reflection.md](reflection.md).
